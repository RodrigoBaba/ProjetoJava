...
public class Investimento {
	...
	public void imprimirTesouro() {
		...
		System.out.println("\n1 - Tesouro Selic 2024: 7,75% a.a - Investindo R$1000,00 seu dinheiro renderia R$" + teste);
		
		calculo = (2027 - 2021) * (1000 * 0.0775);
		teste = df.format(calculo);
		System.out.println("2 - Tesouro Selic 2027: 7,75% a.a - Investindo R$1000,00 seu dinheiro renderia R$" + teste);
		
		calculo = (2026 - 2021) * (1000 * (0.0455 + 0.0526));
		teste = df.format(calculo);
		System.out.println("3 - Tesouro IPCA+ 2026: IPCA + 5,26% (Inflação 4,55% a.a) - Investindo R$1000,00 seu dinheiro renderia R$" + teste);
		
		calculo = (2029 - 2021) * (1000 * (0.0455 + 0.0875));
		teste = df.format(calculo);
		System.out.println("4 - Tesouro IPCA+ 2029: IPCA + 8,75% (Inflação 4,55% a.a) - Investindo R$1000,00 seu dinheiro renderia R$" + teste);
	}
		...
		while(resp == 'S' || resp == 's') {
			...
			while(opcao == 1 || opcao == 2 || opcao == 3 || opcao == 4) {
				...
				case 1:
					...
					String teste = df.format(selic24);
					String teste2 = df.format(investe);
